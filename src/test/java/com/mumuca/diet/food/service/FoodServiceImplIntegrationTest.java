...
class FoodServiceImplIntegrationTest {
    ...
    @Test
    @Transactional
    @DisplayName("should get food successfully")
    void shouldGetFood() {
        // Arrange
    ...
    @Test
    @Transactional
    @DisplayName("should get food nutritional information successfully")
    void shouldGetFoodNutritionalInformation() {
        // Arrange
        User user = createUser();
        userRepository.save(user);
    ...
    @Test
    @Transactional
    @DisplayName("should list meals that contain food successfully")
    void shouldListMealsThatContainFood() {
        // Arrange
        User user = createUser();
        userRepository.save(user);
    ...
    @Test
    @Transactional
    @DisplayName("should paginate foods successfully")
    void shouldPaginateFoods() {
        // Arrange
        User user = createUser();
        userRepository.save(user);
